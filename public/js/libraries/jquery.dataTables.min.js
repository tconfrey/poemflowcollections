...
/*
 * Modified for poemflow.com
 * -- Modified copy: "Entries," "records," etc => "poems"
 * -- Uses custom jquery UI theme (jquery-ui-1.7.2.custom.css)
*/
...
sLengthMenu:"Show _MENU_ poems",sZeroRecords:"No matching records found",sEmptyTable:"No data available in table",sInfo:"Showing _START_ to _END_ of _TOTAL_ poems",sInfoEmpty:"Showing 0 to 0 of 0 poems",sInfoFiltered:"(filtered from _MAX_ total poems)",sInfoPostFix:"",sSearch:"Search:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"}};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch=
